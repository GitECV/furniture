      ...
      renderElement = (
        <div className="GUI-material">
          ...
          <div className='material-selector'>
              <Avatar onClick={mesilla1}  shape="circle" size='xlarge' image={ 'https://i.imgur.com/WwbfYHJ.jpg' } />
              <Avatar onClick={mesilla2} shape="circle" size='xlarge' image={ 'https://i.imgur.com/XQmwJSf.jpg' } />
              <Avatar onClick={mesilla3} shape="circle" size='xlarge' image={ 'https://i.imgur.com/98GIojX.jpg' } />
              <Avatar onClick={mesilla4} shape="circle" size='xlarge' image={ 'https://i.imgur.com/ywoPoXJ.jpg' } />
            </div>
            <h2>Barniz</h2>
      ...
      case "Pomo":
        renderElement = (
          <div className="GUI-material">
            <h1>Pomo</h1>
            <div className='material-selector'>
                <Avatar onClick={pomo1}  shape="circle" size='xlarge' image={ 'https://i.imgur.com/0bJyAIr.png' } />
                <Avatar onClick={pomo2}  shape="circle" size='xlarge' image={ 'https://i.imgur.com/cBpQpf7.jpg' } />
                <Avatar onClick={pomo3} shape="circle" size='xlarge' image={ 'https://i.imgur.com/9hDNvGh.jpg' } />
              </div>
              <h2>Pulido</h2>
